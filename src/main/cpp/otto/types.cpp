...
//;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
stdstr LString::encoded() const{ return d::escape(value); }
//;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
stdstr LVec::pr_str(bool p) const{
  auto& ts= d::getIntTokens();
  return map__val(ts,d::TokenType::T_LBRACKET) +
         LSequential::pr_str(p) + map__val(ts,d::TokenType::T_RBRACKET); }
//;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
LHash::LHash(d::VSlice more){
  ...
  if(!a::is_even(more.size()))
     E_SYNTAX("Wanted even n# of args, got %d near %s", c, "");
...
d::DValue LHash::dissoc(d::VSlice more) const{
  std::map<stdstr,VPair> m(values);
  for(auto i= more.begin;
      i != more.end; ++i) m.erase(hash_key(*i));
  return MAP_VAL(m);
}
//;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
d::DValue LHash::seq() const{
  d::ValVec out;
  for(auto x=values.begin(),
      e=values.end(); x != e; ++x){
    auto p= _2_(x);
    s__conj(out, LIST_VAL2(_1(p), _2(p))); }
  return LIST_VAL(out);
}
//;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
d::DValue LHash::rest() const{
  ...
  if(auto z= s->count(); z > 1)
    for(auto i=1;i<z;++i) s__conj(out, s->nth(i));
  return LIST_VAL(out);
}
//;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
stdstr LHash::pr_str(bool p) const{
  ...
  return map__val(ts,d::TokenType::T_LBRACE) +
         out + map__val(ts,d::TokenType::T_RBRACE);
}
//;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
stdstr LSet::pr_str(bool p) const{
  ...
  auto& ts=d::getIntTokens();
  return map__val(ts,d::TokenType::T_HASH)+
         map__val(ts,d::TokenType::T_LBRACE)+ out + map__val(ts,d::TokenType::T_RBRACE); }
//;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
